...
public class Tt_ctPainani_ {
    ...
    @SerializedName("cApellidoPat")
    @Expose
    private String cApellidoPat;

    @SerializedName("cApellidoMat")
    @Expose
    private String cApellidoMat;

    @SerializedName("lVehiculo")
    @Expose
    ...
    @SerializedName("deVelProm")
    @Expose
    private String deVelProm;
    ...
    public String getDeVelProm() {
        return deVelProm;
    }

    public void setDeVelProm(String deVelProm) {
